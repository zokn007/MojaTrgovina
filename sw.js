...
const ASSETS=['./','./index.html','./manifest.json','./cloud-sync.js','./update-manager.js','./version.json','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./logo-lidl.jpeg','./logo-hofer.jpeg','./logo-spar.png','./logo-mercator.png','./logo-dm.jpeg','./logo-tus.png'];
